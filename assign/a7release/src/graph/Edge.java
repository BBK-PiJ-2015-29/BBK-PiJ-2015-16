 ...
 * <br><br>
 * <p>
 * There are no public Edge constructors, so classes outside the package
...
public final class Edge implements GraphElement {
     ...
     *
     * @throws IllegalArgumentException: if exits is null or has length not equal to 2
     ...
     *
     * @throws IllegalArgumentException: if lengthOfRoad is less than 1 and not equal to Edge.DUMMY_LENGTH
     *                                   if either of the nodes are null
     ...
     */
    @Override
    public boolean isColourSignificant() {
        return false;
    }
